<div id="hmbkp-constants">
    ...
    <dl>
        ...
        <dd><p><?php printf( __( 'The root directory that is backed up. Defaults to %s.', 'hmbkp' ), '<code>' . hmbkp_get_home_path() . '</code>' ); ?><p class="example">e.g. <code>define( 'HMBKP_ROOT', ABSPATH . 'wp/' );</code></p></dd>
