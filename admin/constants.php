	...
	<table class="widefat">
		...
		<tr<?php if ( defined( 'HMBKP_PATH' ) ) { ?> class="hmbkp_active"<?php } ?>>
			...
			<td>
				...
				<p><?php printf( __( 'The path to folder you would like to store your backup files in, currently %s.', 'hmbkp' ), '<code>' . esc_html( hmbkp_path() ) . '</code>' ); ?> <?php _e( 'e.g.', 'hmbkp' ); ?> <code>define( 'HMBKP_PATH', '/home/willmot/backups' );</code></p>
