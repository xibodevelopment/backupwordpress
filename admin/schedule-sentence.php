...
$server = '<code title="' . __( 'Check the help tab to learn how to change where your backups are stored.', 'backupwordpress' ) . '">' . str_replace( Path::get_home_path(), '', Path::get_path() ) . '</code>';
...
switch ( $schedule->get_max_backups() ) :
	...
	case 0 :
		...
		$backup_to_keep = __( 'don\'t store any backups in on this server', 'backupwordpress' );
