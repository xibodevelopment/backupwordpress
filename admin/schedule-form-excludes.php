				...
				<td>
					...
					<?php
						...
						<a href="<?php echo hmbkp_admin_action_url( 'remove_exclude_rule', array(
							...
							) ); ?>" class="delete-action"><?php _e( 'Stop excluding', 'hmbkp' ); ?></a>
	...
	<tr>
		...
		<th scope="col">
			...
			<?php if ( $schedule->get_root() !== $directory ) { ?>
				...
				<a href="<?php echo remove_query_arg( 'hmbkp_directory_browse' ); ?>"><?php echo esc_html( $schedule->get_root() ); ?></a>
				<code>/</code>
				...
				if ( $size !== false ) {
					...
					<code>
						...
						<a class="dashicons dashicons-update"
						   href="<?php echo wp_nonce_url( add_query_arg( 'hmbkp_recalculate_directory_filesize', urlencode( $schedule->get_root() ) ), 'hmbkp-recalculate_directory_filesize' ); ?>"><span><?php _e( 'Refresh', 'hmbkp' ); ?></span></a>
		...
		<tr>
					...
					if ( false !== $size ) {
						...
						<code>
							...
							<?php if ( $file->isDir() ) { ?>
								...
								<a title="<?php _e( 'Recalculate the size of this directory', 'hmbkp' ); ?>"
								   class="dashicons dashicons-update"
								   href="<?php echo wp_nonce_url( add_query_arg( 'hmbkp_recalculate_directory_filesize', urlencode( $file->getPathname() ) ), 'hmbkp-recalculate_directory_filesize' ); ?>"><span><?php _e( 'Refresh', 'hmbkp' ); ?></span></a>
			...
			<td>
				...
				<?php if ( $file->isLink() ) { ?>
					...
					<span
						title="<?php echo esc_attr( $file->GetRealPath() ); ?>"><?php _e( 'Symlink', 'hmbkp' ); ?></span>
			...
			<td class="column-format">
				...
				<?php if ( $is_unreadable ) { ?>
					...
					<strong
						title="<?php _e( 'Unreadable files won\'t be backed up.', 'hmbkp' ); ?>"><?php _e( 'Unreadable', 'hmbkp' ); ?></strong>
				...
				<?php
					...
					<a href="<?php echo wp_nonce_url( add_query_arg( array(
					   ...
					   class="button-secondary"><?php _e( 'Exclude &rarr;', 'hmbkp' ); ?></a>
...
<p class="submit">
	<a href="<?php echo esc_url( hmbkp_get_settings_url() ) ?>"
	   class="button-primary"><?php _e( 'Done', 'hmbkp' ); ?></a>
</p>