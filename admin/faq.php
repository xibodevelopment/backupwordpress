...
<p><?php esc_html_e( 'No.', 'backupwordpress' ); ?></p>

<p><strong><?php esc_html_e( 'I\'m not receiving my backups by email', 'backupwordpress' ); ?></strong></p>

<p><?php esc_html_e( 'Most servers have a filesize limit on email attachments, it\'s generally about 10mb. If your backup file is over that limit, it won\'t be sent attached to the email. Instead, you should receive an email with a link to download the backup. If you aren\'t even receiving that, then you likely have a mail issue on your server that you\'ll need to contact your host about.', 'backupwordpress' ); ?></p>

<p><strong><?php esc_html_e( 'How many backups are stored by default?', 'backupwordpress' ); ?></strong></p>

<p><?php esc_html_e( 'BackUpWordPress stores the last 10 backups by default.', 'backupwordpress' ); ?></p>

<p><strong><?php esc_html_e( 'How long should a backup take?', 'backupwordpress' ); ?></strong></p>

<p><?php esc_html_e( 'Unless your site is very large (many gigabytes) it should only take a few minutes to perform a backup. If your back up has been running for longer than an hour, it\'s safe to assume that something has gone wrong. Try de-activating and re-activating the plugin. If it keeps happening, contact support.', 'backupwordpress' ); ?></p>
...
<p><?php esc_html_e( 'If your backups are failing, it\'s commonly caused by a lack of available resources on your server. To establish this is the case, exclude the complete (or parts of the) uploads folder and run a backup. If that succeeds, you know it\'s probably a server issue. If it does not succeed, report the results to our support team for further help. You can contact support by enabling support from your Admin Dashboard (recommended), or emailing backupwordpress@hmn.md', 'backupwordpress' ); ?></p>
