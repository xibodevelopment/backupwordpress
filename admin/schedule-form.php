...
<p class="description"><strong><?php esc_html_e( 'Please use 24-hour format for hours', 'backupwordpress' ); ?></strong></p>

					<p class="twice-js description<?php if ( $schedule->get_reoccurrence() !== 'fortnightly' ) { ?> hidden<?php } ?>"><?php _e( 'The second backup will run 12 hours after the first', 'backupwordpress' ); ?></p>
