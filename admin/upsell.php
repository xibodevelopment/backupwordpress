<div class="hmbkp-upsell">
	...
	<span><?php printf( __( 'or buy the %s now for only &dollar;99 (all Destinations &amp; Unlimited Sites).', 'backupwordpress' ), '<a target="_blank" href="https://bwp.hmn.md/checkout?edd_action=add_to_cart&download_id=36">' . __( 'Developer Bundle', 'backupwordpress' ) . '</a>' ); ?></span>
