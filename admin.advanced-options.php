<div id="hmbkp_advanced-options">
    ...
    <dl>
        ...
        <dd><p><?php _e( 'Comma separated list of files or directories to exclude, the backups directory is automatically excluded.', 'hmbkp' ); ?><p class="example">e.g. <code>define( 'HMBKP_EXCLUDES', '/wp-content/uploads/, /stats/, .svn/, *.txt' );</code></p></dd>
