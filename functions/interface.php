...
function hmbkp_get_backup_row( $file, HMBKP_Scheduled_Backup $schedule ) {
	...
	<tr class="hmbkp_manage_backups_row<?php if ( file_exists( hmbkp_path() . '/.backup_complete' ) ) : ?> completed<?php unlink( hmbkp_path() . '/.backup_complete' ); endif; ?>">
		...
		<td>
			...
			<a href="<?php echo esc_url( wp_nonce_url( $download_action_url, 'hmbkp-download_backup' ) ); ?>"><?php _e( 'Download', 'hmbkp' ); ?></a> |
			<?php endif; ?>

			<a href="<?php echo esc_url( wp_nonce_url( $delete_action_url, 'hmbkp-delete_backup' ) ); ?>" class="delete-action"><?php _e( 'Delete', 'hmbkp' ); ?></a>
