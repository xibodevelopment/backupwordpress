...
function hmbkp_schedule_actions( HMBKP_Scheduled_Backup $schedule ) {
	...
	<span class="hmbkp-status"><?php echo $schedule->get_status() ? esc_html( $schedule->get_status() ) : __( 'Starting Backup', 'hmbkp' ); ?>
		<a href="<?php echo esc_url( add_query_arg( array( 'action' => 'hmbkp_cancel', 'hmbkp_schedule_id' => $schedule->get_id() ), HMBKP_ADMIN_URL ) ); ?>"><?php _e( 'cancel', 'hmbkp' ); ?></a></span>
